        ...
        <>
            {!isEditing ? (
                <div ref={setNodeRef} style={style} {...attributes} {...listeners}>
                    ...
                    >
                        <Card className="w-full rounded-lg border shadow-sm hover:shadow-md transition-shadow cursor-grab">
                                ...
                                <div className="flex justify-between items-start">
                                    <div className="flex gap-2">
                                        ...
                                        {task.storyPoints > 0 && (
                                            <Badge
                                                variant="secondary"
                                                className="text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200"
                                            >
                                                {task.storyPoints} SP
                                            </Badge>
                                        )}
                                            ...
                                            <Avatar className="h-6 w-6">
                                                <AvatarImage
                                                    src={
                                                        task.assignedTo
                                                            .profilePhoto
                                                            ? task.assignedTo.profilePhoto.startsWith(
                                                                  "http"
                                                              )
                                                                ? task.assignedTo
                                                                      .profilePhoto
