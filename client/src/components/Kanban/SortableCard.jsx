        ...
        <>
            {!isEditing ? (
                <motion.div
                    ...
                    className="w-60 h-40  p-5 bg-inherit rounded-xl my-5 flex flex-col gap-4 shadow-lg border  border-gray-100 transition-all duration-300 cursor-pointer hover:shadow-xl border-b-10 border-b-violet-300 hover:border-b-violet-500"
                >
                    {/* Proirity & Status */}
