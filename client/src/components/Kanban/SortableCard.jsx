        ...
        <>
            {!isEditing ? (
                <motion.div
                    ...
                    className="w-60 h-40  p-5 bg-violet-100 rounded-xl my-5 flex flex-col gap-4 shadow-lg border  border-gray-100 transition-all duration-300 cursor-pointer hover:shadow-xl"
                >
                    {/* Proirity & Status */}
